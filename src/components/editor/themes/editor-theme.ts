// EditorThemeClasses is not exported from lexical, so we'll define our own type
type EditorThemeClasses = {
  ...
  table: string;
  tableCell: string;
  tableCellActionButton: string;
  tableCellActionButtonContainer: string;
  tableCellEditing: string;
  tableCellHeader: string;
  tableCellPrimarySelected: string;
  tableCellResizer: string;
  tableCellSelected: string;
  tableCellSortedIndicator: string;
  tableResizeRuler: string;
  tableRowStriping: string;
